...
protocol ColorDateDelegate: class {
...
open class SwiftHSVColorPicker: UIView, ColorWheelDelegate, BrightnessViewDelegate {
    ...
    weak var delegateColor: ColorDateDelegate?
...
//        NotificationCenter.default.post(name: Notification.Name("NotificationIdentifier"), object: colorWheel.color)

//        delegateColor?.colorData(color: colorWheel.color)
    }
