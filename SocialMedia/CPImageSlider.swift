		...
		for index in 0..<count
		{
			...
			if allowCircular && images.count != 0
			{
				if index == 0 {
                    ...
                    imageV.sd_setImage(with:URL(string: images.last!) , placeholderImage: #imageLiteral(resourceName: "Newlogo"))

				}
				else if index > images.count
				{
					//imageV.image = UIImage(named:images.first!)
                    imageV.sd_setImage(with:URL(string: images.first!) , placeholderImage: #imageLiteral(resourceName: "Newlogo"))

				}
				else
				{
					//imageV.image = UIImage(named:images[index - 1])
                    imageV.sd_setImage(with:URL(string: images[index - 1]) , placeholderImage: #imageLiteral(resourceName: "Newlogo"))
			...
			else
			{
                ...
                imageV.sd_setImage(with:URL(string: images[index]) , placeholderImage: #imageLiteral(resourceName: "Newlogo"))
